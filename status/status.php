				...
				<div class="row">
					<div class="col-lg-offset-0 col-md-12">
						<div class="card card-underline">
							<div class="card-head">
								<header><i class="fa fa-fw fa-users"></i> Status </header>
							</div><!--end .card-head -->
							<div class="col-lg-offset-0 col-md-12">
								<?php
								if(isset($_GET['msg']))
									...
									<div class="card-body">
										<div class="row">
											<div class="col-xs-12 col-sm-3 col-md-3 col-lg-2">
												<a class="btn btn-success btn-block" href="manage.php" name="btnAddUser" id="btnAddUser">ADD NEW STATUS</a>
											</div>
										</div>
										<br />
										<div class="col-lg-offset-0 col-md-12">
...
<script type="text/javascript">
	$(document).ready(function()
	{
	    $('#user-tbl').DataTable(
	    {
	        ...
	        "order": [0,'desc'],
	            "ajax":{
	                url :"../process/status_list.php", // json datasource
